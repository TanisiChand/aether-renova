    ...
    <main className="relative bg-[#020203] font-sans">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden bg-[#020203]">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 0 }}>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[820px] h-[600px] bg-[radial-gradient(ellipse_at_center,_rgba(0,240,152,0.13)_0%,_transparent_65%)]" />
        </div>
      ...
      {/* ── Why invest (thesis) ────────────────── */}
      <section id="thesis" className="scroll-mt-24 relative py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6">
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-b from-[#020203] via-[#0a1510] to-[#020203] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
      ...
      {/* ── How to invest ──────────────────────── */}
      <section className="relative py-20 md:py-28 bg-gradient-to-b from-[#020203] via-[#0a1510] to-[#020203]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14 max-w-2xl mx-auto">
