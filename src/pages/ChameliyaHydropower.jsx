...
export default function ChameliyaHydropower() {
  ...
  return (
    <main className="relative bg-[#020203] font-sans">
      ...
      {/* ── Funding timeline ── */}
      <section id="funding" className="relative py-24 bg-gradient-to-b from-[#020203] via-[#0a1510] to-[#020203] overflow-hidden scroll-mt-24">
        <SynergyBackground />
      ...
      <section id="hydrology" ref={hydRef} className="relative py-20 scroll-mt-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
