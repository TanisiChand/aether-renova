            ...
            <div className="p-5 md:p-6 space-y-5">
              ...
              <div className="pt-1">
                {p.detailUrl ? (
                  ...
                  <Link
                    to="/projects"
                    className="group inline-flex items-center justify-center gap-2 rounded-full font-sans font-semibold tracking-wide transition-all duration-300 px-8 py-3.5 text-sm bg-white/[0.06] border border-white/30 text-white hover:border-aether-accent hover:bg-aether-accent/10 hover:text-aether-accent"
                  >
